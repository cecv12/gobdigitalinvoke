...
<body>
	...
	<div>User <b id="subject"></b> made this request.<p><b>User details (from <span id="profileType"></span>)</b></p>
		<p>Username: <span id="username"></span></p>
		<p>Email: <span id="email"></span></p>
		<p>Full Name: <span id="name"></span></p>
		<p>First: <span id="givenName"></span></p>
		<p>Last: <span id="familyName"></span></p>
		<p><span id="expire"></span></p>
	</div>
...
// 		}
		...
		var loadData = function() {
			...
			// alert(keycloak.tokenParsed.preferred_username);
...
// 			createCookie("KEYCLOAK_IDENTITY", keycloak.token, 1)
		...
		var reloadData = function() {
			...
			// .success(loadData)
			// .error(function() {
			// alert("Sesion expirada, se reactivará ")
			// });
		}
...
// 			$.ajax({
//             url: 'http://localhost:8090/auth/realms/claveunica/protocol/openid-connect/userinfo',
//             type: "GET",
//             headers: {
//                 		'Authorization':'Bearer ' + token
//            			 }, 
//             success: function(dataSSO) {
//             	console.log("data: ", dataSSO);
//             	var user = dataSSO.preferred_username;
		...
		$.ajax(
						{
							...
							data : {
								"grant_type" : "password",
								"username" : user,
								"client_id" : "claveunica-cliente",
								"password" : user,
								"client_secret" : "1d2f050f-20bd-467e-838e-52c41b8ae7b7"
							},
							url : "http://localhost:8090/auth/realms/claveunica/protocol/openid-connect/token"
						}).then(function(data) {
