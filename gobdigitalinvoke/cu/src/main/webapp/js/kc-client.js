var tokencu;
	...
	keycloak.init({ onLoad : 'login-required' }).success(function(authenticated) {output('Init Success ('+ (authenticated ? 'Authenticated'
				: 'Not Authenticated') + ')' + 'token clave unica: ' + keycloak.tokenParsed.token_claveunica);
