...
<head>
    ...
    <script src="inicio_claveunica_files/js"></script>
...
<nav class="barra-superior">
  <div class="container">
    ...
    <ul class="nav navbar-nav" style="float: right !important">
      <li id="citizen">
        <a ui-sref="citizen" onclick="location.href=&#39;/&#39;" ui-sref-active="active" href="#" class="active">Ciudadania</a>
      </li>
      <li id="institutional">
        <a ui-sref="institutional" onclick="location.href=&#39;/institucional&#39;" ui-sref-active="active" href="#">Instituciones</a>
      </li>
    </ul>
  </div>
</nav>
...
<header class="navbar navbar-default" style="background-color: #2c558e; border-radius: 0px !important; box-shadow: none">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a ui-sref="citizen.home" class="navbar-brand" style="padding: 0px !important" href="https://claveunica.gob.cl/">
  ...
  <span class="hidden-xs"><strong>mi</strong> claveunica</span>
</button>
